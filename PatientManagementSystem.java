...
public class PatientManagementSystem extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnSubmit) 
        {
             ...
             catch(InvalidPatientDataException c)
             {
                 JOptionPane.showMessageDialog(this, c.getMessage(), "Error Message", JOptionPane.ERROR_MESSAGE);
                }
             ...
             {
                 JOptionPane.showMessageDialog(this, ev.getMessage(), "Error Message", JOptionPane.ERROR_MESSAGE);
              }
             catch(Exception ex)
             {
