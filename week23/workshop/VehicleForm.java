...
public class VehicleForm extends JFrame implements ActionListener 
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        try 
        {
            ...
            if(selectedType.equals("Car")) 
            {
                ...
                int seat = Integer.parseInt(seatsTxt);
                
                String fuelTxt = fuelField.getText().trim();
                int fuel = Integer.parseInt(fuelTxt);
                
                String tankTxt = tankField.getText().trim();
                int tank = Integer.parseInt(tankTxt);
                
                //String name, int speed, int seats, double fuelEfficiency, double tankCapacity) 
                
                Vehicle c1 = new Car(name,speed,seat,fuel,tank);
                vehicles.add(c1);
                displayArea.append(c1.getInfo());
            ...
            else if(selectedType.equals("Bike")) 
            {
                ...
                //tring name, int speed, boolean hasCarrier, int gearCount, double distance)
                Vehicle b1 = new Bike(name,speed,carrier,gear,distance);
                vehicles.add(b1);
                displayArea.append(b1.getInfo());
            }
    ...
    {
        // PART 2: show basic details of the selected index vehicle
        int index = getIndex();
        
        if(index !=-1)
        {
            Vehicle vh = vehicles.get(index);
    ...
    {
        // PART 3: Car--> car operation, Bike --> bike operation // downcasting required
        ...
        if(index!=-1)
        {
            ...
            {
                displayArea.append(c.getInfo());
            }
            
            if(v instanceof Bike b)
            {
                displayArea.append(b.getInfo());
            }
    ...
    {
         // PART 4: Display all vehicles details
    ...
    private void checkVehicleType() 
    {
        ...
        if(index!=-1)
        {
            ...
            {
                displayArea.append("This is bike");
            }
